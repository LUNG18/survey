document.write("<link type='text/css' href='/plugin/layui/css/layui.css' rel='stylesheet' />");
document.write("<link type='text/css' href='/css/q.css' rel='stylesheet' />");

document.write("<script language=javascript src='/plugin/layui/layui.js'></script>");
document.write("<script language=javascript src='/js/item.js'></script>");
document.write("<script language=javascript src='/js/q.js'></script>");
document.write("<script language=javascript src='/js/jquery-1.12.4.min.js'></script>");
